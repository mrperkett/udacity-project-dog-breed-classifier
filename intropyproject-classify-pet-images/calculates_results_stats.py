...
def calculates_results_stats(results_dic):
    ...
    n_dogs_img = len([1 for vals in results_dic.values() if vals[3] == 1])
    n_notdogs_img = len([1 for vals in results_dic.values() if vals[3] == 0])
    n_match = len([1 for vals in results_dic.values() if vals[2] == 1])
    n_correct_dogs = len([1 for vals in results_dic.values() if vals[3] == vals[4] == 1])
