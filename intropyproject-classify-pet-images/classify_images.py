...
def get_classifications(image_classification_str):
    """
    Break the comma-delimited string returned by the model into a list of labels

    Parameters:
        image_classification_str - a comma-delimited string of classification labels
                                    returned by the model. 
                                    Ex: "Maltese dog, Maltese terrier, Maltese"
    Returns:
        labels - a list with each individual classifier label.  Additional white
                 space removed and everything converted to lower case.
                 Ex: ['maltese dog', 'maltese terrier', 'maltese']
    """
